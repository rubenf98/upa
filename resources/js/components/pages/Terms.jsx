        ...
        <Container>
            <div class="page">
                <div class="translations-content-container">
                    <div class="container">
                        <div class="tab-content translations-content-item en visible" id="en"></div>
                        <h1>Privacy Policy</h1>
                        <p>Last updated: October 07, 2022</p>
                        ...
                        <p>We use Your Personal data to provide and improve the Service. By
                            ...
                            created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank">TermsFeed Privacy Policy Generator</a>.</p>
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Unidos Pela Atividade.</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p><strong>Website</strong> refers to Unidos Pela Atividade, accessible from <a href="https://www.termsfeed.com/live/unidospelaatividade.pt/" rel="external nofollow noopener" target="_blank">unidospelaatividade.pt/</a></p>
                            </li>
                            <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <p>By phone number: +351 925 022 532</p>
                            </li>
                        </ul>
                    </div>
                </div >
